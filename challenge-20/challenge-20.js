 (function(){
	...
	*/
	...
	var $inputUsername = document.querySelector('input[name="name"]');
	...
	*/
	...
	$button.addEventListener( 'click', function(event){
		...
		var confirmation = window.confirm( 'Tem certeza que deseja enviar o formulário?' );
	...
	*/
	...
	function isValidEmail( email ){
		var regexEmailTester = RegExp( '(^[\\w_+.]+@[\\w_]+\\.\\w{2,}(?:\\.\\w{2})?$)', 'gm' )
		// console.log( regexEmailTester );
		return regexEmailTester.test( email );
	}
	
	// console.log( isValidEmail( 'eu.email+categoria@gmail.com' ) );
