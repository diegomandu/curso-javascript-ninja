...
(function(){
  ...
  console.log( hasClass( markup, 'text' ) + ' para a classe container');
  console.log( hasClass( markup, 'date' ) + ' para a classe container');
  console.log( hasClass( markup, 'excerpt' ) + ' para a classe container');
  console.log( hasClass( markup, 'main' ) + ' para a classe container');
